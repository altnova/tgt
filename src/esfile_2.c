...
S desktop_path()											//<	returns strin with a path to Desktop dir 
{
...
S choose_name(S path, S filename)								//< unique enumerated file_name like path/to/dir/nnn_filename
{
...
V make_file(S path, S new_file, S str)							//< make file with unique name and write in str
{																
